...
from .dataset import AllWeather, LowLevel_Cityscapes, Raindrop, Snow100K, Synthetic_Rain, Outdoor_Rain, OTS, CDD11
...
def create_dataset(augment_enable: bool = False, task_name: str = '', ds_name: str = '', 
    ...
    elif 'cdd11' in ds_name:
        dataset = CDD11(dataset_root=dataset_root,
                             task='derain' if task_name == 'low_level' else task_name,
                             split=split,
                             transforms=transforms,
                             random_crop_ratio=random_crop_ratio)
