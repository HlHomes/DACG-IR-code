...
from MulWeatherData import create_dataset
...
def run_denoise_60(opts, net, dataset, factor=8):
    run_test(opts, net, dataset, factor)

def run_denoise_75(opts, net, dataset, factor=8):
    run_test(opts, net, dataset, factor)

def run_denoise_100(opts, net, dataset, factor=8):
    run_test(opts, net, dataset, factor)
